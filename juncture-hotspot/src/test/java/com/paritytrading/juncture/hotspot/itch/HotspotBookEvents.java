...
class HotspotBookEvents implements HotspotBookListener {

    public static final int PRICE_DECIMALS = 4;

    private List<Event> events;

    public HotspotBookEvents() {
    ...
    @Override
    public void newOrder(HotspotBook.NewOrder message) {
    ...
    @Override
    public void modifyOrder(HotspotBook.ModifyOrder message) {
        String currencyPair = ASCII.get(message.currencyPair);
        String orderId      = ASCII.get(message.orderId);
        long   amount       = ASCII.getLong(message.amount);
        long   minqty       = ASCII.getLong(message.minqty);
    ...
    @Override
    public void cancelOrder(HotspotBook.CancelOrder message) {
        String currencyPair = ASCII.get(message.currencyPair);
        String orderId      = ASCII.get(message.orderId);
    ...
    @Override
    public void marketSnapshotEntry(HotspotBook.MarketSnapshotEntry entry) {
    ...
    @Override
    public void ticker(HotspotBook.Ticker message) {
