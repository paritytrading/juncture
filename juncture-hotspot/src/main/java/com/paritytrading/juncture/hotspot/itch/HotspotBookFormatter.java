...
/**
 * A formatter for outbound Hotspot Book Protocol messages.
 */
public class HotspotBookFormatter {

    private State state;

    /**
     * Create a formatter for outbound Hotspot Book Protocol messages.
     */
    public HotspotBookFormatter() {
        state = new State();
    }
